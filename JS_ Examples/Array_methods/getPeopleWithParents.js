...
console.log(
  people === peopleWithParents, // false
  
  // first person parents exist
  typeof peopleWithParents[0].father, // 'object'
  typeof peopleWithParents[0].mother, // 'object'
  typeof people[0].father, // 'string'
  typeof people[0].mother, // 'string'

  // father and mother are objects from new array (NOT the initial one)
  peopleWithParents.includes(peopleWithParents[0].father), // true
  peopleWithParents.includes(peopleWithParents[0].mother), // true

  // second person parents do NOT exist 
  typeof peopleWithParents[1].father, // 'string'
  typeof peopleWithParents[1].mother, // 'string'
)
*/
...
const peopleWithParents = getPeopleWithParents(peopleArr);
